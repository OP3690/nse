...
def download_for_date(d: dt.date) -> dict | None:
    ...
    # cash history dense even if a daily run is missed; figures match NSE.
    try:
    ...
    # All-indices snapshot (broad + sector + India VIX) JSON API.
    try:
